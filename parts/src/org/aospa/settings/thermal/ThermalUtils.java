...
// УДАЛЕНО: импорт отсутствующего HAL
...
public final class ThermalUtils {
    ...
    // ИЗМЕНЕНО: mTouchFeature теперь просто Object или можно вообще удалить
    private Object mTouchFeature = null; 
    ...
    protected ThermalUtils(Context context) {
        ...
        // УДАЛЕНО: Попытка получить сервис touchfeature
        /*
        try {
    ...
    protected void setThermalProfile(String packageName) {
        ...
        // ИЗМЕНЕНО: Отключаем обновление тач-режимов, так как HAL нет
        /*
    ...
    private void updateTouchModes(String packageName) {
        // Метод оставлен пустым, чтобы не ломать вызовы, если они есть в других местах
    }
